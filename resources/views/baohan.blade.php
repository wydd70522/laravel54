...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('homes/img/1.png') }}">
  <link rel="stylesheet" href="{{ asset('homes/css/lenovo.css') }}">
  <script src="{{ asset('homes/js/jquery.js') }}"></script>
  <script src="{{ asset('homes/js/index.js') }}"></script>
</head>
<body>
  <!-- 头 -->
  <!-- 顶部 -->
@include('public.header')<!-- 模板包含 -->
  <!-- 顶部图片 -->
