...
<head>
	...
	<link rel="shortcut icon" href="{{ asset('admins/img/1.png') }}">
	<link rel="stylesheet" href="{{ asset('admins/bs/css/bootstrap.min.css') }}">
	<script src="{{ asset('admins/bs/js/jquery.min.js') }}"></script>
	<script src="{{ asset('admins/bs/js/bootstrap.min.js') }}"></script>
	<style>
		.navbar-blue{
		...
		<nav class="navbar navbar-default navbar-fixed-top navbar-blue" role="navigation">
			...
			<!-- 导航logo -->
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img style="display:inline" width="30px" src="{{ asset('admins/img/1.png') }}" alt="">   云知梦后台管理系统</a>
				</div>
